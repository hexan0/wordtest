...
function doPost_active(e){
 ...
 const WhatContents = "現在学習可能なのは\n"+
                      "英単語　-一般的な英単語(国公立2次レベル)\n"+
                      "共通英語　-共通テストレベルの平易な英単語\n"+
                      "DUO　-例文を穴埋め形式でテスト\n"+
                      "DUO単語　-単語を出題\n"+
                      "1900　-某英単語帳\n"+
                      "330 -古文単語330\n"+
   ...
   switch (status) {
     ...
     case 1://内容指定
       switch(message){
         ...
         case "duo単語":
         case "Duo単語":
           writeUserData(userId,UserDataCol.Content,"3");//content
           break;
         case "共通英語":
         case "共英":
         case "ka":
         case "ke":
           writeUserData(userId,UserDataCol.Content,"4");//content
           break;
         case "CE":
         case "ce":
           writeUserData(userId,UserDataCol.Content,"5");//content
           break;
         case "講習":
           writeUserData(userId,UserDataCol.Content,"6");//content
           break;
         case "ターゲット":
         case "1900":
         case "ターゲット1900":
         ...
         case "古文単語330":
         case "330":
           writeUserData(userId,UserDataCol.Content,"9");//content
           break;
         case "パス単準1級":
           writeUserData(userId,UserDataCol.Content,"21");//content
           break;
         case "パス単2級":
           writeUserData(userId,UserDataCol.Content,"12");//content
           break;
         case "パス単3級":
           writeUserData(userId,UserDataCol.Content,"13");//content
           break;
         case "パス単4級":
           writeUserData(userId,UserDataCol.Content,"14");
           break;
         default:
